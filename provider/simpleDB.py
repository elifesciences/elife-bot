...
class SimpleDB(object):
    ...
    def elife_get_article_S3_file_items(self, file_data_type=None, doi_id=None,
                                        last_updated_since=None, latest=None):
        """
        From the SimpleDB domain for the S3FileLog, return a list of matching item to the attributes
        ...
        query = self.elife_get_article_S3_query(date_format, domain_name_env, file_data_types,
                                                bucket_name, file_data_type, doi_id,
                                                last_updated_since)
    ...
    def elife_get_article_S3_query(self, date_format, domain_name, file_data_types,
                                   bucket_name=None, file_data_type=None, doi_id=None,
    ...
    def elife_get_email_queue_items(self, query_type="items", sort_by=None, limit=None,
                                    sent_status=None, email_type=None, doi_id=None,
                                    date_scheduled_before=None, date_sent_before=None,
                                    recipient_email=None):
        """
        From the SimpleDB domain for the EmailQueue, return list of matching item to the attributes
    ...
    def elife_get_email_queue_query(self, date_format, domain_name, query_type="items",
                                    sort_by=None, limit=None, sent_status=None,
                                    email_type=None, doi_id=None, date_scheduled_before=None,
                                    date_sent_before=None, recipient_email=None):
        """
        ...
        if date_scheduled_before:
            ...
            timestamp = calendar.timegm(date_str)
            if timestamp:
                where_clause += (where_delimiter + " date_scheduled_timestamp < '" +
                                 str(timestamp) + "'")
                where_delimiter = " and"
    ...
    def elife_get_unique_email_queue_item_name(self, domain_name=None, check_is_unique=None,
                                               timestamp=None, doi_id=None, email_type=None,
                                               recipient_email=None):
        """
    ...
    def elife_add_email_to_email_queue(self, recipient_email, sender_email, email_type,
                                       date_added_timestamp=None, date_scheduled_timestamp=0,
                                       doi_id=None, format="text", recipient_name=None,
                                       sender_name=None, subject=None, body=None, add=True):
        """
