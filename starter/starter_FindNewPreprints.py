...
"""
Amazon SWF FindNewPreprints starter
"""


class starter_FindNewPreprints(Starter):
    def __init__(self, settings=None, logger=None):
        super(starter_FindNewPreprints, self).__init__(
            settings, logger, "FindNewPreprints"
        )
...
if __name__ == "__main__":
    ...
    STARTER = starter_FindNewPreprints(SETTINGS)
