...
"""
Amazon SWF FindReingestPreprint starter
"""


class starter_FindReingestPreprint(Starter):
    def __init__(self, settings=None, logger=None):
        super(starter_FindReingestPreprint, self).__init__(
            settings, logger, "FindReingestPreprint"
        )
...
if __name__ == "__main__":
    ...
    STARTER = starter_FindReingestPreprint(SETTINGS)
