...
class starter_SilentCorrectionsProcess(Starter):
    def __init__(self, settings=None, logger=None):
        super(starter_SilentCorrectionsProcess, self).__init__(
            settings, logger, "SilentCorrectionsProcess"
        )
    ...
    def get_workflow_params(self, info):
        ...
        if (
            ...
            raise NullRequiredDataException(
                ...
                "Possible error: Lax did not send back valid data."
            )
