...
class TestConditionalStarts(unittest.TestCase):
    ...
    @data(
        {
            "comment": "21:00 UTC",
            "date_time": "1970-01-01 21:00:00 UTC",
            "expected_starter_names": [
                "cron_FiveMinute",
                "starter_DepositCrossref",
                "starter_FindReingestPreprint",
    ...
    def test_conditional_starts_21_00_utc(self, test_data):
        self.conditional_start_test_run(test_data)
    ...
    @data(
        {
            "comment": "22:00 UTC",
            "date_time": "1970-01-01 22:00:00 UTC",
            "expected_starter_names": [
                "cron_FiveMinute",
                "starter_DepositCrossref",
                "starter_FindReingestPreprint",
    ...
    def test_conditional_starts_23_15_utc(self, test_data):
        self.conditional_start_test_run(test_data)
