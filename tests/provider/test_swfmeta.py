...
class FakeSWFConnection:
    ...
    def list_open_workflow_executions(self, domain=None, workflow_id=None, workflow_name=None,
                                      workflow_version=None, oldest_date=None,
                                      latest_date=None, maximum_page_size=None,
