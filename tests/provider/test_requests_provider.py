...
class TestRequestsProviderPostAs(unittest.TestCase):
    ...
    def test_get_as_params(self, fake_connection):
        ...
        url = "http://localhost/"
        payload = OrderedDict([("type", "digest"), ("content", '<p>"98%"β</p>')])
    ...
    def test_post_as_data(self, fake_connection):
        ...
        params = OrderedDict([("apiKey", api_key), ("accountKey", account_key)])
...
class TestRequestsProviderPost(unittest.TestCase):
    ...
    def test_post_to_endpoint_404(self, post_mock):
        ...
        with self.assertRaises(HTTPError):
            requests_provider.post_to_endpoint(
                url, payload, self.fake_logger, identifier
            )
        self.assertEqual(
    ...
    def test_post_to_endpoint_exception(self, post_mock):
        ...
        self.assertEqual(self.fake_logger.logexception, "Exception in post_to_endpoint")
...
"""
        body = requests_provider.success_email_body_content(
