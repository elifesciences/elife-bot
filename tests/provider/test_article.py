...
class TestArticleWasEverPublished(unittest.TestCase):
    ...
    def test_was_ever_published(self, fake_storage_context):
        ...
        self.assertTrue(self.articleprovider.was_ever_published("10.7554/eLife.2444", workflow))
        self.assertTrue(self.articleprovider.was_ever_published("10.7554/eLife.2419", workflow))
        self.assertFalse(self.articleprovider.was_ever_published("10.7554/eLife.666", workflow))
