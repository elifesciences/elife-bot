...
class TestLaxProvider(unittest.TestCase):
    ...
    @patch("provider.lax_provider.article_versions")
    def test_article_publication_date_200_no_versions(
        self, mock_lax_provider_article_versions
    ):
        mock_lax_provider_article_versions.return_value = 200, []
        date_str = lax_provider.article_publication_date("08411", settings_mock)
    ...
    def test_article_version_200(self, mock_requests_get):
        ...
        response.json.return_value = {
            "versions": [{"status": "preprint"}, {"version": 1}]
        }
    ...
    def test_article_version_500(self, mock_requests_get):
        ...
        self.assertRaises(
            ...
            lax_provider.article_highest_version,
            "08411",
            settings_mock,
        )
    ...
    def test_prepare_action_message(self, fake_xml_file_name):
        ...
        message = lax_provider.prepare_action_message(
            settings_mock,
            "353",
            "bb2d37b8-e73c-43b3-a092-d555753316af",
    ...
    def test_was_ever_poa_was_not_poa(self, mock_lax_provider_article_versions):
        article_id = "04132"
        mock_lax_provider_article_versions.return_value = 200, [
            test_data.lax_article_by_version_response_data_incomplete
        ]
        result = lax_provider.was_ever_poa(article_id, settings_mock)
    ...
    @unpack
    def test_published_considering_poa_status(
        self,
        is_poa,
        was_ever_poa,
        ...
        published = lax_provider.published_considering_poa_status(
            article_id, settings_mock, is_poa, was_ever_poa
        )
    ...
    @unpack
    def test_published_considering_poa_status_500(
        self,
        is_poa,
        was_ever_poa,
        expected_return_value,
    ...
    def test_article_retracted_status_related_insight_only(self, mock_article_related):
        related_article_json = [{"type": "insight"}]
        mock_article_related.return_value = 200, related_article_json
    ...
    def test_article_status_version_map(self, mock_lax_provider_article_versions):
        ...
        version_status_map = lax_provider.article_status_version_map(
            article_id, settings_mock
        )
    ...
    def test_article_first_by_status_first_vor(self, mock_version_status_map):
        ...
        status = "vor"
        expected = True
        first = lax_provider.article_first_by_status(
            article_id, version, status, settings_mock
        )
