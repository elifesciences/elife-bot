...
class TestEmailVideoArticlePublished(unittest.TestCase):
    ...
    @data(
        ...
        },
        {
            ...
            "input_data": activity_data(
                BASE_ACTIVITY_DATA, "7", "vor", "silent-correction"
            ),
            "activity_success": activity_object.ACTIVITY_SUCCESS,
        },
        {
    ...
    def test_do_activity_templatest_error(
        self,
        test_data,
        fake_emit,
        fake_processing_storage_context,
    ...
    @data(
        {"recipient": {}, "email_type": "", "expected": False},
        {
    ...
    def test_send_email(self, test_data, fake_smtp_send_messages):
        ...
        fake_smtp_send_messages.return_value = OrderedDict(
            [("error", 1), ("success", 1)]
        )
