...
import starter.starter_IngestMeca as starter_module
from starter.starter_IngestMeca import (
    starter_IngestMeca as starter_object,
)
...
class TestStarterIngestMeca(unittest.TestCase):
    def setUp(self):
