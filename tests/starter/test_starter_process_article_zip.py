...
class TestStarterProcessArticleZip(unittest.TestCase):
    def setUp(self):
        self.stater_post_perfect_publication = starter_ProcessArticleZip()
    ...
    def test_process_article_zip_starter_(self, fake_boto_conn, fake_logger):
        ...
        self.stater_post_perfect_publication.start(settings=settings_mock, **test_data.data_ingested_lax)
