...
from starter.starter_FindFuturePreprints import starter_FindFuturePreprints
from tests.activity.classes_mock import FakeLogger
from tests.classes_mock import FakeSWFClient
import tests.settings_mock as settings_mock


class TestStarterFindFuturePreprints(unittest.TestCase):
    def setUp(self):
        self.fake_logger = FakeLogger()
        self.starter = starter_FindFuturePreprints(settings_mock, self.fake_logger)
