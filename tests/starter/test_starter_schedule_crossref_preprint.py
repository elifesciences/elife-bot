...
import starter.starter_ScheduleCrossrefPreprint as starter_module
from starter.starter_ScheduleCrossrefPreprint import (
...
class TestStarterScheduleCrossrefPreprint(unittest.TestCase):
    def setUp(self):
    ...
    def test_main(self, fake_client):
        ...
        version = "1"
        testargs = [
            "starter_ScheduleCrossrefPreprint.py",
            "-e",
            env,
            "-a",
            article_id,
