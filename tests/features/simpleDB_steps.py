...
@step(u'I get the generic bucket query from the SimpleDB provider')
def i_get_the_generic_bucket_query_from_the_simpledb_provider(step):
  world.query = world.db.elife_get_generic_delivery_S3_query(
    date_format = world.date_format,
    domain_name = world.domain_name,
    bucket_name = world.bucket_name,
    last_updated_since = world.last_updated_since)
