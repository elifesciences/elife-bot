...
class activity_VersionDateLookup(Activity):
    def __init__(self, settings, logger, conn=None, token=None, activity_task=None):
        ...
        self.description = (
            "Looks up version date on Lax endpoints and stores version date in session "
    ...
    def do_activity(self, data=None):
        ...
        try:
            ...
            version_date, error = self.get_version(
                self.settings, article_structure, article_structure.article_id, version
            )
    ...
    def get_version(self, settings, article_structure, article_id, version):
        try:
            ...
            version_date = lax_provider.article_version_date_by_version(
                article_id, version, settings
            )
            return version_date, None
        except Exception as e:
