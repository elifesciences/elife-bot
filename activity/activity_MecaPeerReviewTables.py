...
class activity_MecaPeerReviewTables(MecaBaseActivity):
    "MecaPeerReviewTables activity"

    def __init__(self, settings, logger, client=None, token=None, activity_task=None):
        super(activity_MecaPeerReviewTables, self).__init__(
            settings, logger, client, token, activity_task
        )

        self.name = "MecaPeerReviewTables"
        self.version = "1"
    ...
    def do_activity(self, data=None):
        ...
        if file_transformations:
            ...
            rename_file_detail_list = collect_table_file_details(
            ...
            copy_file_detail_list = collect_table_file_details(
...
def collect_table_file_details(root, file_transformations, content_subfolder):
    "table-wrap file details for use in XML from the file transformation data"
    variant_data = {
        "parent_tag_name": "table-wrap",
