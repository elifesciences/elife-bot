...
class activity_LensXMLFilesList(activity.activity):
    ...
    def __init__(self, settings, logger, conn=None, token=None, activity_task=None):
        ...
        self.description = ("Create the eLife Lens xml list file for cache warming, " +
                            "and then save those to the S3 CDN bucket.")
    ...
    def get_xml_list(self):
        ...
        for x in xml_item_list:
            ...
            url = ('https://s3.amazonaws.com/' + self.settings.cdn_bucket + '/elife-articles/' +
