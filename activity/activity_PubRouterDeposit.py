...
class activity_PubRouterDeposit(activity.activity):
    ...
    def approve_articles(self, articles):
      ...
      for article in articles:
        blacklisted = self.is_article_on_blacklist(article.doi_id)
    ...
    def is_article_on_blacklist(self, doi_id):
        """
        ...
        if doi_id in self.get_article_blacklist():
          return True      
        else:
          return False
        
    def get_article_blacklist(self):
        """
