...
"""
UnzipArticleSuppl activity
"""

class activity_UnzipArticleSuppl(activity.activity):
  ...
  def do_activity(self, data = None):
    ...
    for tmp_doc_path in tmp_document_path_list:
      ...
      s3key_name = self.get_suppl_object_S3key_name(elife_id, tmp_document)
    ...
    if(self.logger):
      self.logger.info('UnzipArticleSuppl: %s' % elife_id)
  ...
  def get_suppl_object_S3key_name(self, elife_id, document):
    """
