...
class workflow_PublishPDF(workflow.workflow):
	...
	def __init__(self, settings, logger, conn = None, token = None, decision = None, maximum_page_size = 100):
		...
		# SWF Defaults
		self.name = "PublishPDF"
		self.version = "1"
		self.description = "Publish article PDF workflow"
		...
		workflow_definition = {
			...
			[
				...
				{
					"activity_type": "UnzipArticlePDF",
					"activity_id": "UnzipArticlePDF",
					"version": "1",
					"input": data,
					"control": None,
					"heartbeat_timeout": 300,
