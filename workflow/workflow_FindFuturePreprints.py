...
class workflow_FindFuturePreprints(Workflow):
    def __init__(
        self,
        settings,
        logger,
        ...
        super(workflow_FindFuturePreprints, self).__init__(
        ...
        self.version = "1"
        self.description = "Find preprint versions with a future publlication date"
        ...
        workflow_definition = {
            ...
            "steps": [
                ...
                define_workflow_step("FindFuturePreprints", data),
            ],
