...
class workflow_FindReingestPreprint(Workflow):
    def __init__(
        self,
        settings,
        logger,
        ...
        super(workflow_FindReingestPreprint, self).__init__(
        ...
        self.version = "1"
        self.description = (
            "Find preprint versions to reingest and start worklfows for each"
        )
        ...
        workflow_definition = {
            ...
            "steps": [
                ...
                define_workflow_step("FindReingestPreprint", data),
            ],
