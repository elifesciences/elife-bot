...
class workflow_SilentIngestMeca(Workflow):
    def __init__(
        self,
        settings,
        logger,
        ...
        super(workflow_SilentIngestMeca, self).__init__(
            settings, logger, client, token, decision, maximum_page_size
        )

        # SWF Defaults
        self.name = "SilentIngestMeca"
        self.version = "1"
        self.description = "Silent correction ingest preprint MECA file and modify it"
