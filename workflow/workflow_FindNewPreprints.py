...
class workflow_FindNewPreprints(Workflow):
    def __init__(
        self,
        settings,
        logger,
        ...
        super(workflow_FindNewPreprints, self).__init__(
        ...
        self.version = "1"
        self.description = "Find newly published preprint article versions"
        ...
        workflow_definition = {
            ...
            "steps": [
                ...
                define_workflow_step("FindNewPreprints", data),
            ],
