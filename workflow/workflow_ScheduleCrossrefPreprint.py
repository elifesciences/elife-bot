...
class workflow_ScheduleCrossrefPreprint(Workflow):
    def __init__(
        self,
        settings,
        logger,
        ...
        super(workflow_ScheduleCrossrefPreprint, self).__init__(
        ...
        self.version = "1"
        self.description = "Generate preprint XML and schedule it for Crossref deposit"
